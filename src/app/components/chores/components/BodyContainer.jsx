        ...
        <div className="front-body__container">
              ...
              <div className="front-body__container__contenido">
                ...
                <div className="front-body__container__contenido__text">
                  ...
                  <h1 className="front-body__container__contenido__text__titulo">Desarrollar vistas de un Ecommerce</h1>
                  <p className="front-body__container__contenido__text__contenido">Crear las vistas de las pantallas que vera el usuario final del aplicativo ecommerce</p>
                </div>
